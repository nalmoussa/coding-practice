...
import com.nalmoussa.coding.practice.problem019.WellFormedParentheses;
import com.nalmoussa.coding.practice.utils.Strings;

class ChemicalFormula {
    private final NumberOfAtoms numberOfAtoms;
    ...
    private static boolean isValidFormula(String input) {
        return  (input != null)
                ...
                && WellFormedParentheses.isWellFormedParentheses(Strings.keepParentheses(input));
    }
    ...
    private NumberOfAtoms process(String formula) {
