package com.nalmoussa.coding.practice.utils;
...
public class Strings {
    ...
    public static String keepParentheses(String input) {
        String output = null;
        if (input != null) {
    ...
    public static String generateLongString(int length, char ch) {
